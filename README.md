# Apple-XCFramework-KochavaEntitlements

![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/kochava/Apple-XCFramework-KochavaEntitlements?include_prereleases)
